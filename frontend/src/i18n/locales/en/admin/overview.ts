export default {
    ...
    users: {
      ...
      bulkLimits: {
        resetTokenQuota: 'Reset GPT token usage',
        resettingTokenQuota: 'Resetting...',
        resetTokenQuotaHint: 'Restart all 1/7/30-day GPT quota calculations from now. Historical logs are kept and earlier usage no longer counts toward limits.',
        resetTokenQuotaConfirm: 'Reset GPT token usage for {count} users?\nQuota usage will restart from the current time; historical logs will be kept.',
        resetTokenQuotaSuccess: 'Reset GPT token usage for {count} users',
        resetTokenQuotaFailed: 'Failed to reset GPT token usage',
        ...
        enableTokenLimits: 'Update GPT token limits',
        gptTokenLimits: 'GPT token limits',
        tokenLimit1d: 'Daily limit',
        tokenLimit7d: '7-day limit',
        tokenLimit30d: '30-day limit',
        tokenLimitsHint: 'Only GPT models count. The daily limit resets at 07:00 local time; 7-day and 30-day limits are rolling. Use 0 for unlimited.',
        enablePlatformUsage: 'Update platform usage',
        platformUsageTitle: 'Platform usage',
        dailyUsage: 'Daily used (USD)',
        weeklyUsage: 'Weekly used (USD)',
        leaveUnchanged: 'Leave unchanged',
        platformUsageHint: 'Daily and weekly quota windows are calculated from 07:00 local time.',
        unlimited: 'Unlimited',
        nonNegativeInteger: 'Enter a non-negative whole number.',
        invalidValue: 'Enter non-negative numbers. Concurrency and RPM must be whole numbers.',
        apply: 'Apply limits',
        applying: 'Applying...',
        concurrencyValue: 'Concurrency: {value}',
        rpmValue: 'RPM: {value}',
        rpmUnlimitedValue: 'RPM: Unlimited',
        tokenLimit1dValue: 'Daily GPT tokens: {value}',
        tokenLimit7dValue: '7-day GPT tokens: {value}',
        tokenLimit30dValue: '30-day GPT tokens: {value}',
        dailyUsageValue: '{platform} daily used: ${value}',
        weeklyUsageValue: '{platform} weekly used: ${value}',
      ...
      form: {
        ...
        tokenLimitsTitle: 'GPT token limits',
        tokenLimitsHint: 'Only gpt-* requests count input, output, cache creation, and cache read tokens. The daily limit resets at 07:00 local time; 7-day and 30-day limits are rolling. Use 0 for unlimited.',
        tokenLimit1d: 'Daily (resets 07:00)',
        tokenLimit7d: 'Last 7 days',
        tokenLimit30d: 'Last 30 days',
        tokenLimitPlaceholder: '0 = unlimited',
        tokenLimitInvalid: 'Token limits must be non-negative whole numbers',
        modelRestrictionsTitle: 'Model and reasoning restrictions',
        modelRestrictionsHint: 'Model patterns support * wildcards. Deny selected reasoning efforts or the entire model.',
        addModelRestriction: 'Add rule',
        noModelRestrictions: 'No model restrictions',
        modelPatternPlaceholder: 'For example: gpt-5.6-sol or gpt-5.6-sol*',
        modelPatternRequired: 'Every restriction must include a model pattern',
        reasoningEffortsHint: 'Select no efforts to deny the matching model entirely.'
      },
      columns: {
        user: 'User',
        id: 'ID',
