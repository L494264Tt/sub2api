export default {
  promptAudit: {
    ...
    conversations: {
      ...
      roles: { user: '用户', assistant: '助手', system: '系统', developer: '开发者', tool: '工具' },
      history: '历史消息', context: '系统提示词与工具上下文', responseContext: '模型工具调用与附加输出', savedRequest: '已保存请求详情',
      noUserMessage: '本次请求未包含可识别的用户文本。', noResponse: '本次没有已保存的文本回复。',
      messageTruncated: '内容已截断', contextTruncated: '附加上下文达到独立记录上限，部分内容未保存。',
      omittedMessages: '有 {count} 条较早的消息因记录上限未保存。',
      auxiliaryInput: '辅助请求输入', auxiliaryNote: '根据系统提示词和回复格式，该请求疑似客户端安全检查，并非普通聊天回复。',
      legacyNote: '旧版记录未分离用户消息和系统上下文。展开“已保存请求详情”可查看原有文本；已经截断的内容无法恢复。',
