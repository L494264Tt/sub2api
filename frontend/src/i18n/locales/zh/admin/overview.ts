export default {
    ...
    users: {
      ...
      createUser: '创建用户',
      bulkLimits: {
        resetTokenQuota: '重置 GPT Token 统计',
        resettingTokenQuota: '重置中...',
        resetTokenQuotaHint: '将 1/7/30 天 GPT 限额统计起点改为当前时间；历史日志会保留，重置前用量不再计入限额。',
        resetTokenQuotaConfirm: '确定重置 {count} 个用户的 GPT Token 统计吗？\n重置后将从当前时间重新计算，历史日志仍会保留。',
        resetTokenQuotaSuccess: '已重置 {count} 个用户的 GPT Token 统计',
        resetTokenQuotaFailed: '重置 GPT Token 统计失败',
        action: '批量设置限制（{count}）',
        title: '批量设置用户限制',
        ...
        enableTokenLimits: '修改 GPT Token 限额',
        gptTokenLimits: 'GPT Token 限额',
        tokenLimit1d: '日限额',
        tokenLimit7d: '7 天限额',
        tokenLimit30d: '30 天限额',
        tokenLimitsHint: '仅统计 GPT 模型。日限额每天北京时间 07:00 重置，7 天和 30 天限额保持滚动；填 0 表示不限额。',
        enablePlatformUsage: '修改平台已用量',
        platformUsageTitle: '平台已用量',
        dailyUsage: '日已用 (USD)',
        weeklyUsage: '周已用 (USD)',
        leaveUnchanged: '留空不修改',
        platformUsageHint: '日/周额度窗口按本地时间早上 7 点计算。',
        unlimited: '不限制',
        nonNegativeInteger: '请输入非负整数。',
        invalidValue: '请输入非负数字，并发和 RPM 必须为整数。',
        apply: '应用限制',
        applying: '应用中...',
        concurrencyValue: '并发数：{value}',
        rpmValue: 'RPM：{value}',
        rpmUnlimitedValue: 'RPM：不限制',
        tokenLimit1dValue: 'GPT 日限额：{value}',
        tokenLimit7dValue: 'GPT 7 天限额：{value}',
        tokenLimit30dValue: 'GPT 30 天限额：{value}',
        dailyUsageValue: '{platform} 日已用：${value}',
        weeklyUsageValue: '{platform} 周已用：${value}',
      ...
      form: {
        ...
        tokenLimitsTitle: 'GPT Token 限额',
        tokenLimitsHint: '仅统计 gpt-* 请求的输入、输出、缓存创建和缓存读取 Token；日限额每天北京时间 07:00 重置，7 天和 30 天限额保持滚动；0 表示不限制。',
        tokenLimit1d: '日限额（07:00 重置）',
        tokenLimit7d: '最近 7 天',
        tokenLimit30d: '最近 30 天',
        tokenLimitPlaceholder: '0 表示不限制',
        tokenLimitInvalid: 'Token 限额必须是非负整数',
        modelRestrictionsTitle: '模型与推理档位禁用规则',
        modelRestrictionsHint: '模型支持 * 通配符；可只禁用指定 reasoning effort，也可禁用整个模型。',
        addModelRestriction: '添加规则',
        noModelRestrictions: '暂无禁用规则',
        modelPatternPlaceholder: '例如 gpt-5.6-sol 或 gpt-5.6-sol*',
        modelPatternRequired: '每条禁用规则都必须填写模型模式',
        reasoningEffortsHint: '不勾选任何档位表示禁用匹配到的整个模型。'
      },
      adjustBalance: '调整余额',
